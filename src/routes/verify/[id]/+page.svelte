...
<SiteShell>
  <section class="mx-auto w-[90%] max-w-lg pt-28 pb-16 sm:pb-20">
    <div class="flex flex-col items-center text-center">
      ...
      <h1
        class="mt-4 max-w-xl text-[36px] font-light tracking-tight text-foreground sm:text-[48px]"
      >
        Verify the
    ...
    <p
      class="mt-5 text-center text-xs font-light leading-5 text-muted-foreground"
    >
