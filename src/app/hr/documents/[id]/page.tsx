...
export default function HRDocumentPage() {
  ...
  const inProgressCount = documents.filter((item) => getDocumentStatus(item) === "In Progress").length
    ...
    >
      <div className="grid min-h-0 overflow-auto xl:overflow-hidden">
        <section className="grid min-h-[760px] grid-rows-[auto_minmax(0,1fr)] overflow-hidden bg-[var(--paper)] xl:min-h-0">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground">All Documents / Document</p>
          ...
          <div ref={setupRef} className="min-h-0 overflow-hidden bg-[var(--paper)] p-4">
            <div className="mb-3 flex items-center gap-6 border-b border-border">
              <h2 className="border-b-2 border-primary px-2 pb-2 font-mono text-[10px] font-medium uppercase tracking-widest text-primary">
                Document Setup
              </h2>
              <span className="ml-auto pb-2 font-mono text-[10px] uppercase tracking-widest text-muted-foreground">
            ...
            {isLoading ? (
              <div className="grid h-full min-h-0 overflow-hidden border border-border bg-card lg:grid-cols-[150px_minmax(0,1fr)_178px]">
                ...
                <div className="min-h-[420px] p-6">
                  <Skeleton className="mx-auto h-full max-h-[640px] w-full max-w-[520px]" />
                </div>
              ...
              <DocumentSetupDock document={document} onFieldsChange={updateDocumentFields} fullHeight />
            ) : (
        ...
        <Sheet open={shareOpen} onOpenChange={setShareOpen}>
          <SheetContent hideCloseButton className="left-auto right-0 w-full max-w-[440px] translate-x-full border-l border-r-0 p-0 data-[state=open]:translate-x-0">
