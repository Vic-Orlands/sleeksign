...
CREATE TABLE `__new_documents` (
	...
	`created_at` integer DEFAULT '"2026-05-22T13:11:40.183Z"' NOT NULL
);
...
CREATE TABLE `__new_sessions` (
	...
	`created_at` integer DEFAULT '"2026-05-22T13:11:40.188Z"' NOT NULL,
...
ALTER TABLE `user` ADD `last_workspace_id` text;